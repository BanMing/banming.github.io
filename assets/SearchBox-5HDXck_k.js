import{g as f,h as C,i as D,j as R,t as M,u as L,k as N,o as u,c as m,l as F,v as U,e as y,n as b,m as w,F as G,p as I,a as E,q as v,s as B}from"./app-UtFFBMma.js";import{_ as O}from"./plugin-vue_export-helper-x3n3nnut.js";const _=[{path:"/",title:"Home",pathLocale:"/",contents:[]},{path:"/Animation/MotionMatching.html",title:"Code vs Data Driven Displacement",pathLocale:"/",contents:[{header:"Code vs Data Driven Displacement",slug:"code-vs-data-driven-displacement",content:"原文地址：https://theorangeduck.com/page/code-vs-data-driven-displacement"},{header:"Definitions",slug:"definitions",content:""},{header:"The Simulation Object",slug:"the-simulation-object",content:`把手柄输入转化为预测要移动的物体。 vec3 desired_velocity_update( const vec3 gamepadstick_left, const float camera_azimuth, const quat simulation_rotation, const float fwrd_speed, const float side_speed, const float back_speed)
...
免疫会阻止其他GameplayEffectSpecs的应用。`},{header:"Replication Mode",slug:"replication-mode",content:`Replication Mode
Use Case
Description Full
Single Player
Gameplay Effects are replicated to all clients Mixed
...
Multiplayer,AI-Controlled
GamePlay Effects are not replicated. Gameplay Cues and Gameplay Tags replicated to all clients.`},{header:"Debug",slug:"debug",content:"调试命令：ShowDebug AbilitySystem"},{header:"Reference",slug:"reference",content:`https://docs.unrealengine.com/5.0/en-US/gameplay-ability-system-for-unreal-engine/
