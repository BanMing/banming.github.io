import{g as f,h as C,i as D,j as R,t as M,u as L,k as N,o as u,c as m,l as F,v as U,e as y,n as b,m as w,F as k,p as I,a as E,q as v,s as B}from"./app-f8zbahFJ.js";import{_ as O}from"./plugin-vue_export-helper-x3n3nnut.js";const _=[{path:"/",title:"Home",pathLocale:"/",contents:[]},{path:"/Animation/MotionMatching.html",title:"Code vs Data Driven Displacement",pathLocale:"/",contents:[{header:"Code vs Data Driven Displacement",slug:"code-vs-data-driven-displacement",content:"原文地址：https://theorangeduck.com/page/code-vs-data-driven-displacement"},{header:"Definitions",slug:"definitions",content:""},{header:"The Simulation Object",slug:"the-simulation-object",content:`把手柄输入转化为预测要移动的物体。 vec3 desired_velocity_update( const vec3 gamepadstick_left, const float camera_azimuth, const quat simulation_rotation, const float fwrd_speed, const float side_speed, const float back_speed)
...
https://www.bilibili.com/video/BV12Q4y1S73g`}]},{path:"/Basic/design/Bottom-UpAndTop-Down.html",title:"自底向上与自顶向下的区别",pathLocale:"/",contents:[{header:"自底向上与自顶向下的区别",slug:"自底向上与自顶向下的区别",content:""},{header:"自顶向下模型",slug:"自顶向下模型",content:`在这种设计模型中，这个系统时定制的，我们并不知道系统每个部分的细节是什么。在每个部分中还有更多的细节。如果我们去深入了解一个这样设计的程序，需要一定是时间。这个我们做项目计划一样，我们已经有一个目标。我需要做的就是： 把大的目标分散成小目标
...
不是我们正常的思维方式`}]},{path:"/Basic/design/",title:"程序设计",pathLocale:"/",contents:[{header:"程序设计",slug:"程序设计",content:""}]},{path:"/Basic/algorithm/",title:"算法",pathLocale:"/",contents:[{header:"算法",slug:"算法",content:""}]},{path:"/Basic/language/",title:"语言",pathLocale:"/",contents:[{header:"语言",slug:"语言",content:""}]},{path:"/Basic/math/FixedPoints.html",title:"Fixed Points",pathLocale:"/",contents:[{header:"Fixed Points",slug:"fixed-points",content:`浮点数计算很慢？
定点数在计算是会更快一些
