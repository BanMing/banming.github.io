import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,o as s,a as e}from"./app-DCJjapmY.js";const t="/assets/20211020103235-C83xhWgY.png",i="/assets/20211020104326-UTCXw0n3.png",l={},o=e('<h1 id="movement" tabindex="-1"><a class="header-anchor" href="#movement"><span>Movement</span></a></h1><h2 id="basic-movement" tabindex="-1"><a class="header-anchor" href="#basic-movement"><span>Basic Movement</span></a></h2><p>移动算法的结构图 <img src="'+t+'" alt="" loading="lazy"></p><h3 id="_2d" tabindex="-1"><a class="header-anchor" href="#_2d"><span>2D</span></a></h3><p>角色在2维空间移动，大多数3维游戏也可以看做二维的移动。</p><figure><img src="'+i+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="statics" tabindex="-1"><a class="header-anchor" href="#statics"><span>Statics</span></a></h3><p>在处理角色的位置、转向这些数据使用的公式与算法叫做静态，因为这些数据不含有任何角色移动的数据。数据结构可以定义为：</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>class Static:
    position: Vector
    orientation: float
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="kinematic" tabindex="-1"><a class="header-anchor" href="#kinematic"><span>Kinematic</span></a></h3><p>如果一个角色正在向一个方向移动，突然改变他的速度与方向，这看起来有点突兀。为了让这个运动更加的丝滑，不让角色加速太快。我们就需要一些算法去考虑角色当前的速度，使用合理的加速度去改变速度。</p><p>我们就要记录这个角色的速度与转向的速度(角速度)，我们可以定义数据结构为：</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>class Kinematic:
    position: Vector
    orientation: float
    velocity: Vector
    rotation: float
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="kinematic-movement" tabindex="-1"><a class="header-anchor" href="#kinematic-movement"><span>Kinematic Movement</span></a></h2><h3 id="seek" tabindex="-1"><a class="header-anchor" href="#seek"><span>Seek</span></a></h3><p>给定一个角色的静态数据以及目标的静态数据。来计算角色到目标的方向以及一个直线速度。大概实现如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">KinematicSeek</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="velocity-matching" tabindex="-1"><a class="header-anchor" href="#velocity-matching"><span>VELOCITY MATCHING</span></a></h3><p>把角色的速度与目标的数据设置为一样</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">VelocityMatch</span><span class="token punctuation">:</span>
    character<span class="token punctuation">:</span> Kinematic
    target<span class="token punctuation">:</span> Kinematic
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="looking-where-you-re-going" tabindex="-1"><a class="header-anchor" href="#looking-where-you-re-going"><span>LOOKING WHERE YOU\`RE GOING</span></a></h3><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code> <span class="token keyword">class</span> <span class="token class-name">LookWhereYoureGoing</span> extends Align<span class="token punctuation">:</span>
