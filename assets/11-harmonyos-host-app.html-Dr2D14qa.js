...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="c-部署" tabindex="-1"><a class="header-anchor" href="#c-部署"><span>c. 部署</span></a></h4><p>略</p><hr><p>‍</p>`,46)]))}const b=a(c,[["render",o],["__file","11-harmonyos-host-app.html.vue"]]),g=JSON.parse('{"path":"/GameEngine/Unreal/Platform/11-harmonyos-host-app.html","title":"HarmonyOS 宿主应用搭建","lang":"en-US","frontmatter":{"date":"2026-12-25T00:00:00.000Z","tag":["Unreal Engine","OpenHarmony","HarmonyOS","鸿蒙"]},"git":{"createdTime":1782388552000,"updatedTime":1782391338000,"contributors":[{"name":"BanMing","username":"BanMing","email":"ban-ming@foxmail.com","commits":2,"url":"https://github.com/BanMing"},{"name":"Claude Opus 4.7","username":"Claude Opus 4.7","email":"noreply@anthropic.com","commits":2,"url":"https://github.com/Claude Opus 4.7"}]},"readingTime":{"minutes":16.82,"words":5046},"filePathRelative":"GameEngine/Unreal/Platform/11-harmonyos-host-app.md","localizedDate":"December 25, 2026","excerpt":"\\n<h2>一. 环境准备‌</h2>\\n<table>\\n<thead>\\n<tr>\\n<th>步骤</th>\\n<th>详细说明</th>\\n<th>关键配置与要求</th>\\n</tr>\\n</thead>\\n<tbody>\\n<tr>\\n<td>安装 DevEco Studio</td>\\n<td>下载并安装最新版官方 IDE。   <code>DevEco Studio提供开箱即用的开发体验，将HarmonyOS SDK、Node.js、Hvigor、OHPM、模拟器平台等进行合一打包，简化DevEco Studio安装配置流程。</code></td>\\n<td>建议使用最新稳定版 DevEco Studio。</td>\\n</tr>\\n<tr>\\n<td>SDK</td>\\n<td>HarmonyOS SDK已嵌入DevEco Studio中，无需额外下载配置。   <code>HarmonyOS SDK可以在DevEco Studio安装位置下DevEco Studio\\\\sdk目录中查看。如需进行OpenHarmony应用开发，可通过File &gt; Settings &gt; OpenHarmony SDK页签下载OpenHarmony SDK。</code></td>\\n<td></td>\\n</tr>\\n<tr>\\n<td>开发者账号</td>\\n<td>注册华为开发者账号，完成实名认证（企业或个人）。</td>\\n<td>必须实名认证才能申请正式证书。</td>\\n</tr>\\n</tbody>\\n</table>"}');export{b as comp,g as data};
