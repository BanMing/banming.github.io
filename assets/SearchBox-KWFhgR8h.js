...
https://www.gdcvault.com/play/1027378/Motion-Matching-in-The-Last`}]},{path:"/Animation/MotionMatching/",title:"Motion Matching",pathLocale:"/",contents:[{header:"Motion Matching",slug:"motion-matching",content:""},{header:"播放动画",slug:"播放动画",content:`一段播放动画的代码：
// start
...
速度匹配
精确的末端位置匹配`},{header:"简介",slug:"简介",content:"每一帧都去寻找最合适的动画，然后跳转播放。"},{header:"Mocap",slug:"mocap",content:""},{header:"Code",slug:"code",content:""},{header:"Trick: Posematch only a few bones",slug:"trick-posematch-only-a-few-bones",content:`Local velocity
Feet positions
Feet velocities
Weapon position`},{header:"How to follow a desired trajectory?",slug:"how-to-follow-a-desired-trajectory",content:""},{header:"Match more things",slug:"match-more-things",content:""},{header:"Optimizations",slug:"optimizations",content:`LOD
KD-Tree
...
Displacement from Simulation?`},{header:"Reference",slug:"reference",content:`https://gdcvault.com/play/1023280/Motion-Matching-and-The-Road
https://ubm-twvideo01.s3.amazonaws.com/o1/vault/gdc2016/Presentations/Clavet_Simon_MotionMatching.pdf
https://research.cs.wisc.edu/graphics/Papers/Gleicher/Mocap/mograph.pdf`}]},{path:"/Animation/gameOpenGL/AbstractRender.html",title:"Abstract Renderer",pathLocale:"/",contents:[{header:"Abstract Renderer",slug:"abstract-renderer",content:""},{header:"How to create shader",slug:"how-to-create-shader",content:""},{header:"How to store mesh data in buffers",slug:"how-to-store-mesh-data-in-buffers",content:`使用attribute来存储这些信息，属于每个顶点的信息： Position
Normal
