...
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>‍</p>`,26))])}const f=i(o,[["render",v],["__file","03-ubt-uebuildplatform.html.vue"]]),y=JSON.parse('{"path":"/GameEngine/Unreal/Platform/HarmonyOS/03-ubt-uebuildplatform.html","title":"UBT · UEBuildPlatform（平台构建核心）","lang":"en-US","frontmatter":{"date":"2025-12-25T00:00:00.000Z","tag":["Unreal Engine","OpenHarmony","UBT"]},"git":{"createdTime":1782388552000,"updatedTime":1782474564000,"contributors":[{"name":"BanMing","username":"BanMing","email":"ban-ming@foxmail.com","commits":3,"url":"https://github.com/BanMing"},{"name":"Claude Opus 4.7","username":"Claude Opus 4.7","email":"noreply@anthropic.com","commits":3,"url":"https://github.com/Claude Opus 4.7"}]},"readingTime":{"minutes":4.67,"words":1402},"filePathRelative":"GameEngine/Unreal/Platform/HarmonyOS/03-ubt-uebuildplatform.md","localizedDate":"December 25, 2025","excerpt":"\\n<p>在 UBT 构建平台配置中，通常要实现五个功能模块，<strong>​</strong><code>UEBuildPlatform</code><strong>​</strong>​<strong>是其中的核心</strong>。</p>\\n<table>\\n<thead>\\n<tr>\\n<th>模块类名</th>\\n<th>定位</th>\\n<th>核心职责</th>\\n</tr>\\n</thead>\\n<tbody>\\n<tr>\\n<td>​<code>UnrealTargetPlatform</code></td>\\n<td>平台唯一标识符</td>\\n<td>使用 <code>partial struct</code> 模拟类型安全的枚举，提供全局唯一的平台 ID。</td>\\n</tr>\\n<tr>\\n<td>​<code>TargetRules</code></td>\\n<td>编译参数配置</td>\\n<td>存在于项目的 <code>.Target.cs</code> 文件中，   定义构建游戏客户端、服务器或编辑器所需的高级设置。</td>\\n</tr>\\n<tr>\\n<td>​<code>UnrealArchitectureConfig</code></td>\\n<td>平台架构配置</td>\\n<td>确定当前平台构建时支持哪些CPU架构。</td>\\n</tr>\\n<tr>\\n<td>​<code>UEBuildPlatform</code></td>\\n<td>平台构建逻辑</td>\\n<td>负责管理 SDK 检测、工具链路径和架构支持等支持。</td>\\n</tr>\\n<tr>\\n<td>​<code>UEBuildPlatformFactory</code></td>\\n<td>动态加载与注册</td>\\n<td>负责在 UBT 启动时实例化对应的 <code>UEBuildPlatform</code> 类并进行注册。</td>\\n</tr>\\n</tbody>\\n</table>"}');export{f as comp,y as data};
