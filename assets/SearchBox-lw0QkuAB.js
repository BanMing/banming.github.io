...
Path Cost: Numerical cost associated with a given path.`}]},{path:"/Animation/MotionMatching.html",title:"Code vs Data Driven Displacement",pathLocale:"/",contents:[{header:"Code vs Data Driven Displacement",slug:"code-vs-data-driven-displacement",content:"原文地址：https://theorangeduck.com/page/code-vs-data-driven-displacement"},{header:"Definitions",slug:"definitions",content:""},{header:"The Simulation Object",slug:"the-simulation-object",content:`把手柄输入转化为预测要移动的物体。 vec3 desired_velocity_update( const vec3 gamepadstick_left, const float camera_azimuth, const quat simulation_rotation, const float fwrd_speed, const float side_speed, const float back_speed)
...
当稀缺俘获大脑时，人们的注意里会集中在如何以最有成效的方式去利用自身资源上。`},{header:"资源稀缺换来了专注和回报",slug:"资源稀缺换来了专注和回报",content:""}]},{path:"/Career/performance.html",title:"Performance",pathLocale:"/",contents:[{header:"Performance",slug:"performance",content:""},{header:"主要表现及能力",slug:"主要表现及能力",content:`态度/承诺/积极性
专业精神和优秀品质
团队合作及信任`},{header:"专业技能",slug:"专业技能",content:`程式设计
架构
解决问题`}]},{path:"/Career/zhixing.html",title:"知行",pathLocale:"/",contents:[{header:"知行",slug:"知行",content:""},{header:"管理路口的彷惶",slug:"管理路口的彷惶",content:""},{header:"工程师有哪些发展路径",slug:"工程师有哪些发展路径",content:`技术类 架构师（广）
技术专家（专） 管理类 技术管理者（CTO）
职业经理人（CEO） 创业类 创始人
技术合伙人 顾问类 投资顾问
管理顾问 当然，无论走哪条路，有些能力是共通的，比如规划、带人、沟通等管理能力覆盖了全部八个方向。
因此，我们要有意识地区分“技术管理能力”和“技术管理岗位”这两个概念`},{header:"我到底要不要做管理",slug:"我到底要不要做管理",content:`你是否认同管理的价值呢？
你是否对管理充满热情并享受此工作？
你是否看重在管理方面的成长呢？ 挑战 更大的责任
更立体的视角
更灵活的思维方式 收获 成长感
成就感
影响力
获得感 适不适合做管理 这个选择是否更符合你的初衷？
这个选择是否更能激发你投入的意愿？ 我们都开始考虑做管理了，我们的诉求已经不仅仅是按部就班地做好工作了，
而要追求卓越，收获更大的成长感、成就感和影响力`},{header:"哪些人容易走上管理岗位",slug:"哪些人容易走上管理岗位",content:`天时：机会、时机、大环境、时代背景
地利：你的优势、能力，以及你所负责的工作内容 负责最全局的模块，核心是“广”
负责最核心的技术模块，核心是“深” 人和：你能否得到他人的支持`},{header:"我要不要转回去做技术",slug:"我要不要转回去做技术",content:`烦恼 转管之前没有仔细了解过管理
刚开始做管理，还无法靠管理“安身立命”
认为技术才是自己的“大本营”
其未得之也，患得之；既得之，患失之 患失 做技术管理并不会抛弃技术。
把技术提到更高视角来看待
换一种学习方式来掌握技术 建立你的学习机制
请教专家
共创 做管理主要看结果和成效，对于手段和风格并没有一定之规。
如果你是真心热爱技术，擅长用技术的思路和方案解决问题，
你可以考虑做“技术型”管理者，让“技术范儿”成为你的管理风格 患得 做管理对个人成长和个人发展来说，不会失败。
做管理所积累的能力完全可以迁移到做“技术带头人”这个角色上。 认清现实 从目标出发去看待技术。
从评估得角度去看待技术。
从依靠自己得技术到借助大家得技术。
即使退回去，也回不到原来的路。`},{header:"如何保持技术竞争力",slug:"如何保持技术竞争力",content:`从技术实现到技术评估 结果评估 这究竟是一件什么事情？
希望得到什么结果？
要从哪几个维度去衡量结果从哪几个技术指标去验收成果？ 可行性评估 “能不能做”，是指有没有能力做到。这是一个能力问题。
“值不值得”，是指能力允许，但是否有足够的收益值得做。这是一个选择问题。 投入得资源成本
技术维护成本
技术选型成本
技术升级成本
问题排查成本
...
专项技术调研项目化
和技术专家交流
听取工作汇报 团队里技术最强的那个人 管理者的“技术最强”不体现在技术的专业精深和编码熟练度上，
而体现在能否带着团队高效地交付高质量的产品和服务上。
管理者不能依靠专业上的“技术最强”来让员工服气。
技术强只是让员工服气的方式之一，重要的是管理者对员工有良好的影响力。`},{header:"我似乎不适合做管理",slug:"我似乎不适合做管理",content:`指令式管理：重事不重人，关注目标和结果，喜欢发号施令而不会亲力亲为。
支持式管理：重人不重事，习惯带头冲锋亲力亲为，特别在意团队成员的感受，并乐于分担他们的工作。
教练式管理：重人也重事，关注全局和方向，并在做事上给予教练式辅导和启发。
授权式管理：不重人也不重事，关注目标和结果，不关心过程和人员发展。`},{header:"如何找到管理自信",slug:"如何找到管理自信",content:`因欠缺管理经验和技能 知识，是指你知道和理解的内容和信息，其掌握程度一般用深度和广度来衡量。
技能，是指你能操作和完成的技术，其掌握程度一般用熟练度来衡量。
才干，是你自然而然高频运用的那些思维，行动和感受模式，也包括你的品格特质。
你可以通过梳理自己可迁移的能力，提升能力自信。 如何面对团队里的老资格员工和高能力员工 不是管束和控制大家，而是引导和支持大家。
你要做的，是用大家的力量，去做出更好的成果，
而不是单单因为你的职位让大家服气。
你可以通过把自己从团队成员的对立面抽离，提升角色自信。 因为背负了上级太高的期待而担心做不好 定期向上级汇报团队工作。
请合作伙伴提意见。
你可以通过把自己从团队成员的对立面抽离，提升角色自信。 你也许不是最强的那个人，但是你得知道，你是此时此刻做这事儿最合适的人。`},{header:"管理的基本框架",slug:"管理的基本框架",content:""}]},{path:"/Graphic/",title:"Graphic",pathLocale:"/",contents:[{header:"Graphic",slug:"graphic",content:""},{header:"OpenSource",slug:"opensource",content:"https://github.com/Gforcex/OpenGraphic"}]},{path:"/Playing/android-linux.html",title:"安装Linux在安卓手机上",pathLocale:"/",contents:[{header:"安装Linux在安卓手机上",slug:"安装linux在安卓手机上",content:`直接使用软件安装：https://github.com/EXALAB/AnLinux-App
...
估计还可以不用修改引擎代码来实现，比如说修改批处理的执行、监听某些事件来处理。应该是重写Engine\\Engine\\Source\\Programs\\AutomationTool\\AutomationUtils\\Platform.cs这个类来实现。`}]},{path:"/GameEngine/Unreal/manual/Camera.html",title:"Camera",pathLocale:"/",contents:[{header:"Camera",slug:"camera",content:"Six ingredients for a dynamic third person camera"}]},{path:"/GameEngine/Unreal/manual/Commandline.html",title:"Command Line",pathLocale:"/",contents:[{header:"Command Line",slug:"command-line",content:""},{header:"读取启动命令行命令",slug:"读取启动命令行命令",content:'```cpp\nFString ParameterValue;\nif (FParse::Value(FCommandLine::Get(), TEXT("-LocalClientIndex="), ParameterValue))\n{ LocalUserIndex = FCString::Atoi((*ParameterValue)); UE_LOG(LogBalor, Log, TEXT("Command Line LocalUserIndex@@@@@@: %s "), *ParameterValue);\n}\n```'},{header:"控制台命令行调用",slug:"控制台命令行调用",content:`直接在方法属性中添加Exec即可，在控制台直接使用函数名调用。
UFUNCTION( Exec )
...
We'll use a similar approach (though less complicated) Data Driven Change Input-to-Ability mappings at runtime`},{header:"Ability Task",slug:"ability-task",content:""},{header:"Target Data",slug:"target-data",content:"如果需要使用这个数据，需要调用初始化: // This is required to use Target Data UAbilitySystemGlobals::Get().InitGlobalData(); 使用ServerSetReplicatedTargetData()把数据复制到服务器"},{header:"Gameplay Cue",slug:"gameplay-cue",content:""},{header:"Gameplay Tag",slug:"gameplay-tag",content:`Alt text
可以多出使用Tag： Inputs
Abilities
Attributes
Damage Types
...
在c++中声明自定义Tag，使用UGameplayTagsManager::Get().AddNativeGameplayTag()： // 头文件
...
}`},{header:"Prediction",slug:"prediction",content:"如果客户端使用一个技能，向服务器请求，然后服务器确认给客户端。这里的时间差就会很久。 预测就是，客户端先执行需要使用的技能，同时向服务器发送。服务器在验证后，如果正常就不需要做什么，如果不正常需要取消客户端的技能操作。"},{header:"GAS Automatically Predicts",slug:"gas-automatically-predicts",content:`Gameplay Ability Activation
Triggered Events
