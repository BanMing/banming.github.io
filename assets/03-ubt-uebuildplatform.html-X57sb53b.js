...
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,33)),e("h3",u,[e("a",m,[e("span",null,[n[1]||(n[1]=a("步骤 3：实现 ")),d(l,{to:"/GameEngine/Unreal/Platform/UBT%20-%20UEBuildPlatform.cs/UBT%20-%20UnrealArchitectureConfig.html"},{default:t(()=>n[0]||(n[0]=[a("UBT - UnrealArchitectureConfig")])),_:1}),n[2]||(n[2]=a(" 配置类"))])])]),n[4]||(n[4]=s(`<p>这是构建系统用来管理目标平台的硬件 CPU 架构（例如 Arm64 或 x64）。</p><h4 id="作用说明-2" tabindex="-1"><a class="header-anchor" href="#作用说明-2"><span>作用说明</span></a></h4><p>​<code>UnrealArchitectureConfig</code> 确保编译器能够生成正确的机器码，并根据项目需求（例如支持哪些架构）进行灵活配置。</p><h4 id="指导操作-2" tabindex="-1"><a class="header-anchor" href="#指导操作-2"><span>指导操作</span></a></h4><p>实现<code>OpenHarmonyArchitectureConfig</code> 定义平台支持的架构并实现配置读取逻辑。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">namespace UnrealBuildTool</span>
<span class="line">{</span>
...
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>‍</p>`,26))])}const f=i(o,[["render",v],["__file","03-ubt-uebuildplatform.html.vue"]]),y=JSON.parse('{"path":"/GameEngine/Unreal/Platform/03-ubt-uebuildplatform.html","title":"UBT · UEBuildPlatform（平台构建核心）","lang":"en-US","frontmatter":{"date":"2026-06-25T00:00:00.000Z","tag":["Unreal Engine","OpenHarmony","UBT"]},"git":{"createdTime":1782388552000,"updatedTime":1782388552000,"contributors":[{"name":"BanMing","username":"BanMing","email":"ban-ming@foxmail.com","commits":1,"url":"https://github.com/BanMing"},{"name":"Claude Opus 4.7","username":"Claude Opus 4.7","email":"noreply@anthropic.com","commits":1,"url":"https://github.com/Claude Opus 4.7"}]},"readingTime":{"minutes":4.67,"words":1400},"filePathRelative":"GameEngine/Unreal/Platform/03-ubt-uebuildplatform.md","localizedDate":"June 25, 2026","excerpt":"\\n<p>在 UBT 构建平台配置中，通常要实现五个功能模块，<strong>​</strong><code>UEBuildPlatform</code><strong>​</strong>​<strong>是其中的核心</strong>。</p>\\n<table>\\n<thead>\\n<tr>\\n<th>模块类名</th>\\n<th>定位</th>\\n<th>核心职责</th>\\n</tr>\\n</thead>\\n<tbody>\\n<tr>\\n<td>​<code>UnrealTargetPlatform</code></td>\\n<td>平台唯一标识符</td>\\n<td>使用 <code>partial struct</code> 模拟类型安全的枚举，提供全局唯一的平台 ID。</td>\\n</tr>\\n<tr>\\n<td>​<code>TargetRules</code></td>\\n<td>编译参数配置</td>\\n<td>存在于项目的 <code>.Target.cs</code> 文件中，   定义构建游戏客户端、服务器或编辑器所需的高级设置。</td>\\n</tr>\\n<tr>\\n<td>​<code>UnrealArchitectureConfig</code></td>\\n<td>平台架构配置</td>\\n<td>确定当前平台构建时支持哪些CPU架构。</td>\\n</tr>\\n<tr>\\n<td>​<code>UEBuildPlatform</code></td>\\n<td>平台构建逻辑</td>\\n<td>负责管理 SDK 检测、工具链路径和架构支持等支持。</td>\\n</tr>\\n<tr>\\n<td>​<code>UEBuildPlatformFactory</code></td>\\n<td>动态加载与注册</td>\\n<td>负责在 UBT 启动时实例化对应的 <code>UEBuildPlatform</code> 类并进行注册。</td>\\n</tr>\\n</tbody>\\n</table>"}');export{f as comp,y as data};
