import{g as f,h as C,i as D,j as R,t as M,u as L,k as N,o as u,c as m,l as F,v as U,e as y,n as b,m as w,F as G,p as I,a as E,q as v,s as B}from"./app-Ti0c-EdU.js";import{_ as O}from"./plugin-vue_export-helper-x3n3nnut.js";const _=[{path:"/",title:"Home",pathLocale:"/",contents:[]},{path:"/Animation/MotionMatching.html",title:"Code vs Data Driven Displacement",pathLocale:"/",contents:[{header:"Code vs Data Driven Displacement",slug:"code-vs-data-driven-displacement",content:"原文地址：https://theorangeduck.com/page/code-vs-data-driven-displacement"},{header:"Definitions",slug:"definitions",content:""},{header:"The Simulation Object",slug:"the-simulation-object",content:`把手柄输入转化为预测要移动的物体。 vec3 desired_velocity_update( const vec3 gamepadstick_left, const float camera_azimuth, const quat simulation_rotation, const float fwrd_speed, const float side_speed, const float back_speed)
...
在打包文件夹里执行http-server即可。`}]},{path:"/Animation/CharacterAnimation/SkeletalAnimation.html",title:"Skeletal Animation",pathLocale:"/",contents:[{header:"Skeletal Animation",slug:"skeletal-animation",content:""},{header:"Keyframe animation basics",slug:"keyframe-animation-basics",content:`帧动画由一段时间中几个特定时间点和物体姿势组成。如下图：
Alt text
