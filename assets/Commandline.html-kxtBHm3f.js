import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as n,b as s}from"./app-f8zbahFJ.js";const t={},o=s(`<h1 id="command-line" tabindex="-1"><a class="header-anchor" href="#command-line" aria-hidden="true">#</a> Command Line</h1><h2 id="读取启动命令行命令" tabindex="-1"><a class="header-anchor" href="#读取启动命令行命令" aria-hidden="true">#</a> 读取启动命令行命令</h2><pre><code>\`\`\`cpp
