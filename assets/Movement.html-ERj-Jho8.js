import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{e as a,f as e,o as i}from"./app-BLbTYTRI.js";const t="/assets/20211020103235-C83xhWgY.png",p="/assets/20211020104326-UTCXw0n3.png",l={};function c(o,n){return i(),a("div",null,n[0]||(n[0]=[e('<h1 id="movement" tabindex="-1"><a class="header-anchor" href="#movement"><span>Movement</span></a></h1><h2 id="basic-movement" tabindex="-1"><a class="header-anchor" href="#basic-movement"><span>Basic Movement</span></a></h2><p>移动算法的结构图<br><img src="'+t+'" alt="" loading="lazy"></p><h3 id="_2d" tabindex="-1"><a class="header-anchor" href="#_2d"><span>2D</span></a></h3><p>角色在2维空间移动，大多数3维游戏也可以看做二维的移动。</p><figure><img src="'+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="statics" tabindex="-1"><a class="header-anchor" href="#statics"><span>Statics</span></a></h3><p>在处理角色的位置、转向这些数据使用的公式与算法叫做静态，因为这些数据不含有任何角色移动的数据。数据结构可以定义为：</p><div class="language-c++ line-numbers-mode" data-highlighter="prismjs" data-ext="c++"><pre><code><span class="line">class Static:</span>
