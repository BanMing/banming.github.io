...
架构
解决问题`}]},{path:"/Career/zhixing.html",title:"知行",pathLocale:"/",contents:[{header:"知行",slug:"知行",content:""},{header:"管理路口的彷惶",slug:"管理路口的彷惶",content:""},{header:"如何保持技术竞争力",slug:"如何保持技术竞争力",content:`作为一个技术管理者，即技术应用者技术评估的维度主要体现在以下三个方面： 第一个维度是结果评估
1.这究竟是一件什么事情？
2.希望得到什么结果？
3.要从哪几个维度去衡量结果从哪几个技术指标去验收成果？
第二个维度是可行性评估 “能不能做”，是指有没有能力做到。这是一个能力问题。
“值不值得”，是指能力允许，但是否有足够的收益值得做。这是一个选择问题。`}]},{path:"/Graphic/",title:"Graphic",pathLocale:"/",contents:[{header:"Graphic",slug:"graphic",content:""},{header:"OpenSource",slug:"opensource",content:"https://github.com/Gforcex/OpenGraphic"}]},{path:"/Playing/android-linux.html",title:"安装Linux在安卓手机上",pathLocale:"/",contents:[{header:"安装Linux在安卓手机上",slug:"安装linux在安卓手机上",content:`直接使用软件安装：https://github.com/EXALAB/AnLinux-App
