...
固件下载站：https://darthsternie.net/switch-firmwares/`}]},{path:"/Playing/wechat-gpt.html",title:"Wechat GPT",pathLocale:"/",contents:[{header:"Wechat GPT",slug:"wechat-gpt",content:"https://github.com/fuergaosi233/wechat-chatgpt"}]},{path:"/Tools/AIDraw.html",title:"AI Draw",pathLocale:"/",contents:[{header:"AI Draw",slug:"ai-draw",content:`Viscom.ai
Krea.ai
Topaz Gigapixel`}]},{path:"/Tools/ArtTool.html",title:"Art Tools",pathLocale:"/",contents:[{header:"Art Tools",slug:"art-tools",content:""},{header:"A character generator for Windows and Linux, using LPC assets",slug:"a-character-generator-for-windows-and-linux-using-lpc-assets",content:"https://pflat.itch.io/lpc-character-generator"}]},{path:"/Tools/Cmake.html",title:"CMake",pathLocale:"/",contents:[{header:"CMake",slug:"cmake",content:""},{header:"Building a Basic Project",slug:"building-a-basic-project",content:`CmakeLists.txt：根目录下一定要有的文件
...
https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-blueprint-blend-nodes-in-unreal-engine`}]},{path:"/Gameplay/AI/GameAIModel.html",title:"游戏AI模型",pathLocale:"/",contents:[{header:"游戏AI模型",slug:"游戏ai模型",content:`一般游戏中的AI模块我们都可以它分为三个小块： 移动
行为决策
...
That\`s pretty much all there is to it!! You can read below for a bit more information.`},{header:"MORE INFORMATION",slug:"more-information",content:`The delegate system understands certain types of objects, and additional features are enabled when
...
alt text
因为这里随机数是使用BlueprintPure，他会在每一次取值时候，都被调用一次，也就是重新随机一次。所以在最右边的红色框中，又取了一次值，所以这里会产生两次随机。 设置自定义Tick方法，使用FTickFunction，并可以设置bRunOnAnyThread 让其运行在其他线程。注册该方方法类似：
...
`},...o],page:e,content:null,parentPagePriority:10,priority:10})}}function A(e){const t=e.path.split("/");let s="/";return t[1]&&(s=`/${t[1]}/`),(W.value.get(s)||e).title}function T(e,t){const s=[];let i=0;const c=e.toLowerCase().replace(/\s/gu," ");let o=0,a=c.indexOf(t,o);if(a<0)return null;for(;a>=0;){const n=a+t.length;if(d(e.slice(o,a),"normal"),d(e.slice(a,n),"highlight"),o=n,a=c.indexOf(t,o),i>100)break}return d(e.slice(o),"normal"),s.filter(n=>n.str);function d(n,r){let l=n;r==="normal"&&l.length>100&&i===0&&(l=`… ${l.slice(-10)}`);let p=!1;if(i+l.length>100){if(s.some(g=>g.type==="ellipsis"))return;l=l.slice(0,Math.max(100-i,1)),p=!0}s.push({type:r,str:l}),i+=l.length,p&&(s.push({type:"ellipsis",str:" …"}),i+=2)}}var j={};const V=j,K=R({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>V}},setup(e){const{locales:t}=M(e),s=f(""),i=f(!1),c=f(-1),o=H(s),a=C(()=>s.value&&i.value&&o.value.length),d=L(),n=N(),r=C(()=>t.value[n.value]??{});function l(){if(!a.value)return;let h=c.value-1;h<0&&(h=o.value.length-1),g(h)}function p(){if(!a.value)return;let h=c.value+1;h>=o.value.length&&(h=0),g(h)}function g(h){c.value=h}function P(){c.value=-1}function x(h){if(!a.value)return;const k=o.value[h];k&&d.push(k.path)}return{query:s,focused:i,focusIndex:c,suggestions:o,activeSuggestion:a,onUp:l,onDown:p,focus:g,unfocus:P,go:x,locale:r}}}),Y={class:"search-box",role:"search"},Q=["placeholder"],X=["onMousedown","onMouseenter"],J=["href"],$={key:0,class:"parent-page-title"},Z={class:"suggestion-row"},ee={class:"page-title"},te={class:"suggestion-content"};function ae(e,t,s,i,c,o){return u(),m("div",Y,[F(y("input",{ref:"input","onUpdate:modelValue":t[0]||(t[0]=a=>e.query=a),"aria-label":"Search",class:b({focused:e.focused}),placeholder:e.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:t[1]||(t[1]=()=>e.focused=!0),onBlur:t[2]||(t[2]=()=>e.focused=!1),onKeyup:[t[3]||(t[3]=w(a=>e.go(e.focusIndex),["enter"])),t[4]||(t[4]=w((...a)=>e.onUp&&e.onUp(...a),["up"])),t[5]||(t[5]=w((...a)=>e.onDown&&e.onDown(...a),["down"]))]},null,42,Q),[[U,e.query]]),e.activeSuggestion?(u(),m("ul",{key:0,class:"suggestions",onMouseleave:t[7]||(t[7]=(...a)=>e.unfocus&&e.unfocus(...a))},[(u(!0),m(G,null,E(e.suggestions,(a,d)=>(u(),m("li",{key:d,class:b(["suggestion",{focused:d===e.focusIndex}]),onMousedown:n=>e.go(d),onMouseenter:n=>e.focus(d)},[y("a",{href:a.path,onClick:t[6]||(t[6]=B(()=>{},["prevent"]))},[a.parentPageTitle&&(!e.suggestions[d-1]||e.suggestions[d-1].parentPageTitle!==a.parentPageTitle)?(u(),m("div",$,v(a.parentPageTitle),1)):I("v-if",!0),y("div",Z,[y("div",ee,v(a.title||a.path),1),y("div",te,[(u(!0),m(G,null,E(a.display,(n,r)=>(u(),m("span",{key:r,class:b(n.type)},v(n.str),3))),128))])])],8,J)],42,X))),128))],32)):I("v-if",!0)])}const oe=_(K,[["render",ae],["__scopeId","data-v-76e8af88"],["__file","SearchBox.vue"]]);export{oe as default};
