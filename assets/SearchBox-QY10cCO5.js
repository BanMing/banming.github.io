import{g as f,h as C,i as D,j as R,t as M,u as L,k as N,o as u,c as m,l as F,v as U,e as y,n as b,m as w,F as k,p as I,a as E,q as v,s as B}from"./app-YTGvoulZ.js";import{_ as O}from"./plugin-vue_export-helper-x3n3nnut.js";const _=[{path:"/",title:"Home",pathLocale:"/",contents:[]},{path:"/Animation/MotionMatching.html",title:"Code vs Data Driven Displacement",pathLocale:"/",contents:[{header:"Code vs Data Driven Displacement",slug:"code-vs-data-driven-displacement",content:"原文地址：https://theorangeduck.com/page/code-vs-data-driven-displacement"},{header:"Definitions",slug:"definitions",content:""},{header:"The Simulation Object",slug:"the-simulation-object",content:`把手柄输入转化为预测要移动的物体。 vec3 desired_velocity_update( const vec3 gamepadstick_left, const float camera_azimuth, const quat simulation_rotation, const float fwrd_speed, const float side_speed, const float back_speed)
...
We'll use a similar approach (though less complicated) Data Driven Change Input-to-Ability mappings at runtime`},{header:"Ability Task",slug:"ability-task",content:""},{header:"Target Data",slug:"target-data",content:"使用ServerSetReplicatedTargetData()把数据复制到服务器"},{header:"Gameplay Cue",slug:"gameplay-cue",content:""},{header:"Gameplay Tag",slug:"gameplay-tag",content:`Alt text
可以多出使用Tag： Inputs
Abilities
Attributes
Damage Types
