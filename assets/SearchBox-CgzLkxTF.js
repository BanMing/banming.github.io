...
至于为什么没被打开，是因为CookPatchAssets打开时，Io Store是不被可用的。`},{header:"代码",slug:"代码",content:"比较成熟的解决方案： puerts 鸣潮一些实践建议 UnLua"}]},{path:"/GameEngine/Unreal/manual/Interface.html",title:"Interface",pathLocale:"/",contents:[{header:"Interface",slug:"interface",content:`下面是一个简单的接口示例：
#pragma once
