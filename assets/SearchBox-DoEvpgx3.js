...
至于为什么没被打开，是因为CookPatchAssets打开时，Io Store是不被可用的。`},{header:"代码",slug:"代码",content:`比较成熟的解决方案： puerts
UnLua`}]},{path:"/GameEngine/Unreal/manual/Interface.html",title:"Interface",pathLocale:"/",contents:[{header:"Interface",slug:"interface",content:`下面是一个简单的接口示例：
#pragma once
...
最重要的是在调用接口方法时不需要手动强转一次，虚幻提供了专用的调用方式：`},{header:"Implements",slug:"implements",content:`判断一个对象是否继承与一个接口，使用U开头的类来判读，而不是I开头的。
